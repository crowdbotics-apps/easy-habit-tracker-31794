...
## Project Structure
    ...
    ├── easy_habit_tracker_31794  # Django project configurations
...
1. Clone this repo and `cd easy_habit_tracker_31794`
...
2. Clone this repo and `cd easy_habit_tracker_31794`
